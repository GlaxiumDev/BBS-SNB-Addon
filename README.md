...
| BBS Base | Supported |
| BBS FS | Supported |
| BBS 2.1 (FS fork) | Supported (1.20.4 first) |
...
Minecraft 1.20.4**, including its texture resolver and extended render
...
`./gradlew build -Pbbs_jar=libs/bbs-cml-2.1.1-1.20.4.jar`.
