...
Minecraft 1.20.1**, including its texture resolver and extended render
...
`./gradlew build -Pbbs_jar=libs/bbs-cml-2.1.1-1.20.1.jar`.

To compile against CML and run against BBS 2.1:
`./gradlew runClient -Pbbs_jar=libs/bbs-cml-2.1.1-1.20.1.jar -Pbbs_runtime=libs/bbs-2.1-1.20.1.jar`.
